...
const i18n = {
    en: {
        ...
        power: "POWER", ftaSec: "FTA / sec", pending: "PENDING", fta: "FTA", miningActive: "MINING ACTIVE", noMachine: "NO MACHINE",
        claim: "CLAIM", shopTitle: "⛏️ Shop", machines: "Machines", batteries: "Batteries", buy: "BUY",
        myAssets: "⚙️ Wallet & Assets", walletBal: "💰 Balances", plugMachine: "🔌 Plug in a machine",
        plugDesc: "Enter your offline machine ID and choose a battery.", machineId: "Machine ID (0, 1...)", plug: "PLUG IN ⚡",
        ...
        connWallet: "Connecting...", errConn: "Connection Error", linking: "Linking...", wcIdMissing: "WalletConnect ID missing!",
        refLinked: "Referrer linked successfully!", connFirst: "Connect first", enterRefAddr: "Referrer address (0x...)",
        buyingMachine: "Buying Machine", approveUsdt: "Approving USDT...", approveFta: "Approving FTA...", confirming: "Confirming...",
        calcFta: "Calculating FTA price...", machineBought: "Machine purchased!", buyingBattery: "Buying Battery",
        batteryBought: "Battery purchased!", invalidId: "Invalid Machine ID", pluggingIn: "Plugging in...",
        pluggedIn: "Machine plugged in successfully! ⚡", invalidAmount: "Invalid amount", swapping: "Swapping...",
        swapSuccess: "Swap successful!", claiming: "Claiming...", claimed: "Rewards claimed!", error: "Error", days: "Days", rig: "RIG",
        ...
        mnemonicPhrase: "Mnemonic Phrase (12 words)", privateKey: "Private Key", saveMnemonic: "Save these words securely!",
        importMnemonic: "Import from Mnemonic", importPrivateKey: "Import from Private Key",
        passwordMismatch: "Passwords do not match", walletExists: "A wallet already exists. Unlock or delete it first.",
        deleteWallet: "Delete Wallet", walletDeleted: "Wallet deleted",
    },
    fr: {
        connect: "Connecter", refTitle: "👥 Système de Parrainage", refDesc: "Entrez l'adresse de votre parrain pour le lier.", bindRef: "LIER",
        power: "PUISSANCE", ftaSec: "FTA / sec", pending: "EN ATTENTE", fta: "FTA", miningActive: "MINAGE ACTIF", noMachine: "AUCUNE MACHINE",
        claim: "RÉCLAMER", shopTitle: "⛏️ Boutique", machines: "Machines", batteries: "Batteries", buy: "ACHETER",
        myAssets: "⚙️ Wallet & Actifs", walletBal: "💰 Soldes", plugMachine: "🔌 Brancher une machine",
        plugDesc: "Entrez l'ID de votre machine éteinte et choisissez une batterie.", machineId: "ID Machine (0, 1...)", plug: "BRANCHER ⚡",
        ...
        connWallet: "Connexion...", errConn: "Erreur connexion", linking: "Liaison...", wcIdMissing: "ID WalletConnect manquant !",
        refLinked: "Parrain lié avec succès !", connFirst: "Connectez-vous d'abord", enterRefAddr: "Adresse du parrain (0x...)",
        buyingMachine: "Achat Machine", approveUsdt: "Approbation USDT...", approveFta: "Approbation FTA...", confirming: "Confirmation...",
        calcFta: "Calcul du prix FTA...", machineBought: "Machine achetée !", buyingBattery: "Achat Batterie",
        batteryBought: "Batterie achetée !", invalidId: "ID Machine invalide", pluggingIn: "Branchement...",
        pluggedIn: "Machine branchée ! ⚡", invalidAmount: "Montant invalide", swapping: "Swap...",
        swapSuccess: "Échange réussi !", claiming: "Claim...", claimed: "Gains réclamés !", error: "Erreur", days: "Jours", rig: "RIG",
        send: "Envoyer", receive: "Recevoir", recipientAddr: "Adresse du destinataire (0x...)", amount: "Montant",
        confirmSend: "CONFIRMER ENVOI", sending: "Envoi...", sentSuccess: "Envoi réussi !", addrCopied: "Adresse copiée !",
        invalidAddr: "Adresse invalide", totalBal: "Solde Total",
        createWallet: "Créer un portefeuille", importWallet: "Importer un portefeuille", unlockWallet: "Déverrouiller",
        lockWallet: "Verrouiller", walletLocked: "Portefeuille verrouillé", walletUnlocked: "Portefeuille déverrouillé",
        setPassword: "Définir un mot de passe", confirmPassword: "Confirmer le mot de passe", enterPassword: "Entrer le mot de passe",
        mnemonicPhrase: "Phrase mnémonique (12 mots)", privateKey: "Clé privée", saveMnemonic: "Conservez ces mots en sécurité !",
        importMnemonic: "Importer via Mnemonic", importPrivateKey: "Importer via Clé privée",
        passwordMismatch: "Les mots de passe ne correspondent pas", walletExists: "Un portefeuille existe déjà. Déverrouillez-le ou supprimez-le.",
        deleteWallet: "Supprimer le portefeuille", walletDeleted: "Portefeuille supprimé",
    },
    de: {
        connect: "Verbinden", refTitle: "👥 Empfehlungssystem", refDesc: "Geben Sie die Adresse Ihres Empfehlers ein.", bindRef: "BINDEN",
        power: "LEISTUNG", ftaSec: "FTA / sek", pending: "AUSSTEHEND", fta: "FTA", miningActive: "MINING AKTIV", noMachine: "KEINE MASCHINE",
        claim: "EINFORDERN", shopTitle: "⛏️ Shop", machines: "Maschinen", batteries: "Batterien", buy: "KAUFEN",
        myAssets: "⚙️ Wallet & Assets", walletBal: "💰 Guthaben", plugMachine: "🔌 Maschine anschließen",
        plugDesc: "Geben Sie die ID Ihrer Offline-Maschine ein.", machineId: "Maschinen-ID (0, 1...)", plug: "ANSCHLIESSEN ⚡",
        ...
        connWallet: "Verbindung...", errConn: "Verbindungsfehler", linking: "Verknüpfung...", wcIdMissing: "WalletConnect-ID fehlt!",
        refLinked: "Empfehler verknüpft!", connFirst: "Zuerst verbinden", enterRefAddr: "Empfehler-Adresse (0x...)",
        buyingMachine: "Kaufe Maschine", approveUsdt: "USDT genehmigen...", approveFta: "FTA genehmigen...", confirming: "Bestätigung...",
        calcFta: "FTA-Preis berechnen...", machineBought: "Maschine gekauft!", buyingBattery: "Kaufe Batterie",
        batteryBought: "Batterie gekauft!", invalidId: "Ungültige ID", pluggingIn: "Anschließen...",
        pluggedIn: "Maschine angeschlossen! ⚡", invalidAmount: "Ungültiger Betrag", swapping: "Tauschen...",
        swapSuccess: "Tausch erfolgreich!", claiming: "Einforderung...", claimed: "Eingefordert!", error: "Fehler", days: "Tage", rig: "RIG",
        send: "Senden", receive: "Empfangen", recipientAddr: "Empfängeradresse (0x...)", amount: "Betrag",
        confirmSend: "SENDUNG BESTÄTIGEN", sending: "Senden...", sentSuccess: "Gesendet!", addrCopied: "Kopiert!",
        invalidAddr: "Ungültige Adresse", totalBal: "Gesamtguthaben",
        createWallet: "Neue Wallet erstellen", importWallet: "Wallet importieren", unlockWallet: "Entsperren",
        lockWallet: "Sperren", walletLocked: "Wallet gesperrt", walletUnlocked: "Wallet entsperrt",
        setPassword: "Passwort festlegen", confirmPassword: "Passwort bestätigen", enterPassword: "Passwort eingeben",
        mnemonicPhrase: "Mnemonische Phrase (12 Wörter)", privateKey: "Privater Schlüssel", saveMnemonic: "Bewahren Sie diese Wörter sicher auf!",
        importMnemonic: "Import mit Mnemonic", importPrivateKey: "Import mit privatem Schlüssel",
        passwordMismatch: "Passwörter stimmen nicht überein", walletExists: "Es existiert bereits eine Wallet. Entsperren oder löschen Sie sie zuerst.",
        deleteWallet: "Wallet löschen", walletDeleted: "Wallet gelöscht",
    },
    zh: {
        connect: "连接", refTitle: "👥 推荐系统", refDesc: "输入推荐人地址进行绑定。", bindRef: "绑定",
        power: "算力", ftaSec: "FTA / 秒", pending: "待领取", fta: "FTA", miningActive: "挖矿中", noMachine: "无机器",
        claim: "领取", shopTitle: "⛏️ 商店", machines: "矿机", batteries: "电池", buy: "购买",
        myAssets: "⚙️ 钱包与资产", walletBal: "💰 余额", plugMachine: "🔌 插入机器",
        plugDesc: "输入离线机器ID并选择电池。", machineId: "机器ID (0, 1...)", plug: "插入 ⚡",
        ...
        connWallet: "连接中...", errConn: "连接错误", linking: "绑定中...", wcIdMissing: "缺少 WalletConnect ID！",
        refLinked: "推荐人绑定成功！", connFirst: "请先连接", enterRefAddr: "推荐人地址 (0x...)",
        buyingMachine: "购买机器", approveUsdt: "授权 USDT...", approveFta: "授权 FTA...", confirming: "确认中...",
        calcFta: "计算 FTA 价格...", machineBought: "机器购买成功！", buyingBattery: "购买电池",
        batteryBought: "电池购买成功！", invalidId: "无效ID", pluggingIn: "插入中...",
        pluggedIn: "机器插入成功！ ⚡", invalidAmount: "无效金额", swapping: "兑换中...",
        swapSuccess: "兑换成功！", claiming: "领取中...", claimed: "奖励已领取！", error: "错误", days: "天", rig: "矿机",
        send: "发送", receive: "接收", recipientAddr: "接收方地址 (0x...)", amount: "金额",
        confirmSend: "确认发送", sending: "发送中...", sentSuccess: "发送成功！", addrCopied: "地址已复制！",
        invalidAddr: "无效地址", totalBal: "总余额",
        createWallet: "创建新钱包", importWallet: "导入钱包", unlockWallet: "解锁钱包",
        lockWallet: "锁定钱包", walletLocked: "钱包已锁定", walletUnlocked: "钱包已就绪",
        setPassword: "设置密码", confirmPassword: "确认密码", enterPassword: "输入密码",
        mnemonicPhrase: "助记词 (12个单词)", privateKey: "私钥", saveMnemonic: "请安全保存这些单词！",
        importMnemonic: "助记词导入", importPrivateKey: "私钥导入",
        passwordMismatch: "密码不匹配", walletExists: "钱包已存在，请先解锁或删除。",
        deleteWallet: "删除钱包", walletDeleted: "钱包已删除",
    },
    sg: {
        connect: "Connect", refTitle: "👥 Referral System", refDesc: "Enter your referrer's address to link.", bindRef: "BIND",
        power: "POWER", ftaSec: "FTA / sec", pending: "PENDING", fta: "FTA", miningActive: "MINING ACTIVE", noMachine: "NO MACHINE",
...
class Application {
    constructor() {
        ...
        this.internalWallet = null;        // ethers.Wallet instance after unlock
        this.encryptedWalletJson = localStorage.getItem('fitia_encrypted_wallet') || null;
        this.walletPassword = null;        // only during current session
        this.isInternalWalletLocked = true;
    }
    ...
    applyTranslations() {
        ...
        document.querySelector('#view-my-rigs .card:nth-child(2) h3').innerText = this.t('walletBal');
        ...
        document.querySelector('#view-my-rigs .card:nth-child(3) h3').innerText = `🔌 ${this.t('plugMachine')}`;
        document.querySelector('#view-my-rigs .card:nth-child(3) p').innerText = this.t('plugDesc');
        document.getElementById('plug-machine-id').placeholder = this.t('machineId');
        document.querySelector('#view-my-rigs .card:nth-child(3) .btn-primary').innerText = this.t('plug');
    ...
    async init() { 
        ...
        this.renderInternalWalletUI();
        if (this.encryptedWalletJson && !this.internalWallet) {
            // Could auto-prompt unlock, but we'll let user click
        }
    }

    // ============ INTERNAL WALLET FUNCTIONS ============
    renderInternalWalletUI() {
        const container = document.getElementById('internal-wallet-ui');
        if (!container) return;
        if (this.internalWallet && !this.isInternalWalletLocked) {
            container.innerHTML = `
                <p class="info">✅ ${this.t('walletUnlocked')}: <strong>${this.internalWallet.address.slice(0,6)}...${this.internalWallet.address.slice(-4)}</strong></p>
                <button class="btn-small" onclick="App.lockInternalWallet()">🔒 ${this.t('lockWallet')}</button>
                <button class="btn-small" style="background:#ef4444; margin-top:5px;" onclick="App.deleteInternalWallet()">🗑️ ${this.t('deleteWallet')}</button>
            `;
        } else if (this.encryptedWalletJson) {
            container.innerHTML = `
                <p class="info">🔐 ${this.t('walletLocked')}</p>
                <button class="btn-small" onclick="App.promptUnlock()">🔓 ${this.t('unlockWallet')}</button>
                <button class="btn-small" style="background:#ef4444; margin-top:5px;" onclick="App.deleteInternalWallet()">🗑️ ${this.t('deleteWallet')}</button>
            `;
        } else {
            container.innerHTML = `
                <button class="btn-small" onclick="App.showCreateWallet()">+ ${this.t('createWallet')}</button>
                <button class="btn-small" style="margin-top:5px;" onclick="App.showImportWallet()">📥 ${this.t('importWallet')}</button>
            `;
        }
    }

    showCreateWallet() {
        const modal = document.getElementById('modal-internal-wallet');
        document.getElementById('modal-internal-title').innerText = this.t('createWallet');
        document.getElementById('modal-internal-content').innerHTML = `
            <p class="warning">⚠️ ${this.t('saveMnemonic')}</p>
            <div class="phrase-box" id="generated-mnemonic"></div>
            <div class="input-group">
                <input type="password" id="new-password" placeholder="${this.t('setPassword')}">
                <input type="password" id="confirm-password" placeholder="${this.t('confirmPassword')}">
            </div>
            <button class="btn-primary" id="btn-create-wallet" onclick="App.createWalletFromMnemonic()">${this.t('createWallet')}</button>
        `;
        modal.classList.add('active');
        const wallet = ethers.Wallet.createRandom();
        document.getElementById('generated-mnemonic').innerText = wallet.mnemonic.phrase;
        this._tempMnemonic = wallet.mnemonic.phrase;
    }

    showImportWallet() {
        const modal = document.getElementById('modal-internal-wallet');
        document.getElementById('modal-internal-title').innerText = this.t('importWallet');
        document.getElementById('modal-internal-content').innerHTML = `
            <div style="margin-bottom:10px;">
                <button class="btn-small" onclick="App.showImportMnemonic()">📝 ${this.t('importMnemonic')}</button>
                <button class="btn-small" style="margin-top:5px;" onclick="App.showImportPrivateKey()">🔑 ${this.t('importPrivateKey')}</button>
            </div>
    ...
    showImportMnemonic() {
        ...
        container.innerHTML = `
            <textarea id="import-mnemonic" class="game-input" placeholder="${this.t('mnemonicPhrase')}" rows="3"></textarea>
            <input type="password" id="new-password-mnemonic" placeholder="${this.t('setPassword')}">
            <input type="password" id="confirm-password-mnemonic" placeholder="${this.t('confirmPassword')}">
            <button class="btn-primary" onclick="App.importFromMnemonic()">${this.t('importWallet')}</button>
        `;
    }
    ...
    showImportPrivateKey() {
        const container = document.getElementById('import-form-container');
        container.innerHTML = `
            <input type="text" id="import-private-key" class="game-input" placeholder="${this.t('privateKey')}">
            <input type="password" id="new-password-pk" placeholder="${this.t('setPassword')}">
            <input type="password" id="confirm-password-pk" placeholder="${this.t('confirmPassword')}">
            <button class="btn-primary" onclick="App.importFromPrivateKey()">${this.t('importWallet')}</button>
        `;
    }

    promptUnlock() {
        const modal = document.getElementById('modal-internal-wallet');
        document.getElementById('modal-internal-title').innerText = this.t('unlockWallet');
        document.getElementById('modal-internal-content').innerHTML = `
            <p class="info">🔐 ${this.t('enterPassword')}</p>
            <input type="password" id="unlock-password" placeholder="${this.t('enterPassword')}">
            <button class="btn-primary" id="btn-unlock" onclick="App.unlockWallet()">🔓 ${this.t('unlockWallet')}</button>
        `;
        modal.classList.add('active');
    }
    ...
    async unlockWallet() {
        ...
        if (!password) return this.showToast('Enter password', true);
        try {
            const wallet = await ethers.Wallet.fromEncryptedJson(this.encryptedWalletJson, password);
            this.provider = ethers.getDefaultProvider(CONFIG.CHAIN_ID);
            wallet.connect(this.provider);
            this.internalWallet = wallet;
            this.walletPassword = password;
            this.isInternalWalletLocked = false;
            this.user = wallet.address;
            this.signer = wallet; // Use wallet as signer
            document.getElementById('modal-internal-wallet').classList.remove('active');
            this.renderInternalWalletUI();
            await this.initContractsAndData();
        } catch (e) {
            this.showToast('Wrong password', true);
        }
    }
    ...
    async createWalletFromMnemonic() {
        ...
        if (password !== confirm) return this.showToast(this.t('passwordMismatch'), true);
        if (!this._tempMnemonic) return;
        const wallet = ethers.Wallet.fromPhrase(this._tempMnemonic);
        const encryptedJson = await wallet.encrypt(password);
        localStorage.setItem('fitia_encrypted_wallet', encryptedJson);
        this.encryptedWalletJson = encryptedJson;
        this.provider = ethers.getDefaultProvider(CONFIG.CHAIN_ID);
        wallet.connect(this.provider);
        this.internalWallet = wallet;
        this.walletPassword = password;
        ...
        this.renderInternalWalletUI();
        await this.initContractsAndData();
        this.showToast('Wallet created and unlocked!');
    }

    async importFromMnemonic() {
        const mnemonic = document.getElementById('import-mnemonic').value.trim();
        const password = document.getElementById('new-password-mnemonic').value;
        const confirm = document.getElementById('confirm-password-mnemonic').value;
        if (password !== confirm) return this.showToast(this.t('passwordMismatch'), true);
        try {
            ...
            this.renderInternalWalletUI();
            await this.initContractsAndData();
            this.showToast('Wallet imported and unlocked!');
        } catch (e) {
            this.showToast('Invalid mnemonic', true);
        }
    }

    async importFromPrivateKey() {
        const privateKey = document.getElementById('import-private-key').value.trim();
        const password = document.getElementById('new-password-pk').value;
        const confirm = document.getElementById('confirm-password-pk').value;
        if (password !== confirm) return this.showToast(this.t('passwordMismatch'), true);
        try {
            ...
            this.showToast('Invalid private key', true);
        }
    }
    ...
    deleteInternalWallet() {
        localStorage.removeItem('fitia_encrypted_wallet');
        ...
        document.getElementById('wallet-status').classList.add('hidden');
        this.renderInternalWalletUI();
        this.showToast(this.t('walletDeleted'));
    }
    ...
    async connect() {
        if (this.internalWallet && !this.isInternalWalletLocked) {
            return this.showToast('Internal wallet already active. Lock it first to use external wallet.');
        }
